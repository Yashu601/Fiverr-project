...
<head>
    ...
    <link rel="stylesheet" href="css/help9140.css">
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown">
                                        <a href="HELP.php"class="Logo">
                                            <button class="glow-on-hover" type="button">
                                            <img src="assets/images/NavBar Icons/Help Act.png" class="logo-img inactive" alt="Inactive Logo">
                                    </button>
                                </a>
                                        <div class="dropdown-content">
        ...
        <div class="help topic">
            <div class="help-section">
                <div class="help-content">
                    ...
                    <ul class="faq">
                        <li><strong>Q: Is this a screen print?</strong> <br>
                            A: No, this is a specialty print for garments. Screen printing is available on request.
                        </li>
                        <li><strong>Q: Do you have bulk discounts?</strong> <br>
                            A: Yes we do. Discounts start at 10 pieces of one product.
                        </li>
                        <li><strong>Q: How long before I get my shirt?</strong> <br>
                            A: Approximately 10 business days.
                        </li>
                        <li><strong>Q: Can I change my order once I place it?</strong> <br>
                            A: You generally have 24 hours to change your order before it is fully processed. You can send questions about your order to support@grafixwizard.com.
                        </li>
                        <li><strong>Q: Can you help me with my design?</strong> <br>
                            A: Yes we would be glad to help with your design or any questions you have about it. Contact us at support@grafixwizard.com.
                        </li>
                        <li><strong>Q: Can I Print on a sleeve or leg of an item?</strong> <br>
                            A: Yes we can put it anywhere you like. Contact us at sales@grafixwizard.com and we'll help you out.
                        </li>
                        <li><strong>Q: Can I resale the shirts I buy from you guys?</strong> <br>
                            A: Yes, please do. We love to support other businesses.
                        </li>
                    </ul>
                </div>
            </div>
