                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                <li><i class="fi-rs-smartphone"></i> <a href="#"></a></li>
                                <li><i class="fi-rs-marker"></i><a href="page-contact.php"></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Get great Tshirts up to 50% off</a></li>
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                <div class="header-action-icon-2">
                                    <a href="wishlist.php">
                                        <img class="svgInject" alt="Evara" src="images/icon-heart.svg">
                                        <span class="pro-count blue">4</span>
                                    </a>
                                </div>
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="cart.php">
                                        <img alt="Evara" src="images/icon-cart.svg">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.php"><img alt="Evara" src="images/thumbnail-3.jpg"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.php"><img alt="Evara" src="images/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="shop-grid-right.php"><i class="evara-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href="shop-grid-right.php"><i class="evara-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        <a href="shop-grid-right.php"><i class="evara-font-smartphone"></i> Cellphones</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li><a href="shop-grid-right.php"><i class="evara-font-desktop"></i>Computer &amp; Office</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-cpu"></i>Consumer Electronics</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-diamond"></i>Jewelry &amp; Accessories</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-home"></i>Home &amp; Garden</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-high-heels"></i>Shoes</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-teddy-bear"></i>Mother &amp; Kids</a></li>
                                    <li><a href="shop-grid-right.php"><i class="evara-font-kite"></i>Outdoor fun</a></li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href="shop-grid-right.php"><i class="evara-font-desktop"></i>Beauty, Health</a></li>
                                            <li><a href="shop-grid-right.php"><i class="evara-font-cpu"></i>Bags and Shoes</a></li>
                                            <li><a href="shop-grid-right.php"><i class="evara-font-diamond"></i>Consumer Electronics</a></li>
                                            <li><a href="shop-grid-right.php"><i class="evara-font-home"></i>Automobiles &amp; Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="customize.php">Customize Tshirt</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.php">
                                    <img alt="Evara" src="images/icon-heart.svg">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.php"><img alt="Evara" src="images/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="shop-grid-right.php"><i class="evara-font-dress"></i>Women's Clothing</a></li>
                                <li><a href="shop-grid-right.php"><i class="evara-font-tshirt"></i>Men's Clothing</a></li>
                                <li> <a href="shop-grid-right.php"><i class="evara-font-smartphone"></i> Cellphones</a></li>
                                <li><a href="shop-grid-right.php"><i class="evara-font-desktop"></i>Computer &amp; Office</a></li>
                                <li><a href="shop-grid-right.php"><i class="evara-font-cpu"></i>Consumer Electronics</a></li>
                                <li><a href="shop-grid-right.php"><i class="evara-font-home"></i>Home &amp; Garden</a></li>
                                <li><a href="shop-grid-right.php"><i class="evara-font-high-heels"></i>Shoes</a></li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="shop-grid-right.php">shop</a>
                                <ul class="dropdown">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="blog-category-fullwidth.php">Blog</a>
                                <ul class="dropdown">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="product-detail accordion-detail">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-2.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-1.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-3.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-4.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-5.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-6.jpg" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="images/product-16-7.jpg" alt="product image">
                                            </figure>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="images/thumbnail-3.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-4.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-5.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-6.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-7.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-8.jpg" alt="product image"></div>
                                            <div><img src="images/thumbnail-9.jpg" alt="product image"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook"><a href="#"><img src="images/icon-facebook.svg" alt=""></a></li>
                                            <li class="social-twitter"> <a href="#"><img src="images/icon-twitter.svg" alt=""></a></li>
                                            <li class="social-instagram"><a href="#"><img src="images/icon-instagram.svg" alt=""></a></li>
                                            <li class="social-linkedin"><a href="#"><img src="images/icon-pinterest.svg" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="shop-product-right.php" tabindex="0">
                                                            <img class="default-img" src="images/product-2-1.jpg" alt="">
                                                            <img class="hover-img" src="images/product-2-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="shop-product-right.php" tabindex="0">
                                                            <img class="default-img" src="images/product-3-1.jpg" alt="">
                                                            <img class="hover-img" src="images/product-4-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="shop-product-right.php" tabindex="0">
                                                            <img class="default-img" src="images/product-4-1.jpg" alt="">
                                                            <img class="hover-img" src="images/product-4-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="shop-product-right.php" tabindex="0">
                                                            <img class="default-img" src="images/product-5-1.jpg" alt="">
                                                            <img class="hover-img" src="images/product-3-2.jpg" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                            ...
                            <div class="banner-img banner-big wow fadeIn f-none animated mt-50">
                                <img class="border-radius-10" src="images/banner-4.png" alt="">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href="shop-grid-right.php">Shoes &amp; Bags</a></li>
                                <li><a href="shop-grid-right.php">Blouses &amp; Shirts</a></li>
                                <li><a href="shop-grid-right.php">Dresses</a></li>
                                <li><a href="shop-grid-right.php">Swimwear</a></li>
                                <li><a href="shop-grid-right.php">Beauty</a></li>
                                <li><a href="shop-grid-right.php">Jewelry &amp; Watch</a></li>
                                <li><a href="shop-grid-right.php">Accessories</a></li>
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="shop-grid-right.php">Shop Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
					...
					<div class="col-lg-7 mb-md-3 mb-lg-0">
						<div class="row align-items-center">
							<div class="col flex-horizontal-center">
								<img class="icon-email" src="images/icon-email.svg" alt="">
							...
							<div class="col-md-8 col-lg-12">
								...
								<div class="download-app wow fadeIn animated">
									<a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active"
											src="images/app-store.jpg" alt=""></a>
									<a href="#" class="hover-up"><img src="images/google-play.jpg" alt=""></a>
								</div>
							</div>
							<div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
								<p class="mb-20 wow fadeIn animated">Secured Payment Gateways</p>
								<img class="wow fadeIn animated" src="images/payment-method.png" alt="">
							</div>
						</div>
					</div>
				</div>
